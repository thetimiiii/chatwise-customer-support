...
import { ArrowDownRight, MessageSquare, Zap, Shield } from "lucide-react";
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          <div className="mx-auto max-w-4xl py-24 sm:py-32 text-center">
            ...
            <div className="absolute top-12 left-1/2 transform -translate-x-1/2">
              <ArrowDownRight className="h-16 w-16 text-primary animate-bounce" />
            </div>
          </div>

          <form onSubmit={handleTryDemo} className="max-w-xl mx-auto mt-10">
